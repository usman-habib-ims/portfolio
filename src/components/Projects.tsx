...
const projects = [
  {
    ...
    description:
      "Final Year Project - A comprehensive real estate platform built with MERN Stack and AWS services. Features include secure OAuth authentication, property listing management, and integrated payment system.",
    technologies: [
      "MERN Stack",
  ...
  },
  {
    ...
    description:
      "A secure authentication system built with Next.js, featuring Clerk integration and MongoDB for data storage.",
  ...
  },
  {
    ...
    description:
      "A modern movie discovery platform built with Next.js 14, featuring TMDB API integration and responsive design.",
  ...
  },
  {
    ...
    description:
      "Multiple MERN Stack projects with Next.js frontend and various backend services.",
    ...
    highlights: [
      ...
      "IAM for secure access management , CloudWatch for monitoring , VPC for network isolation",
    ],
  },
];
